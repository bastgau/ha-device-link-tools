...
async def async_setup_platform(hass: HomeAssistant, config, async_add_entities_callback, discovery_info=None):
        ...
        self.forecast_list: list[Forecast] | None = [
            {
                ...
                ATTR_FORECAST_NATIVE_PRECIPITATION: self._values.get("native_precipitation"),
